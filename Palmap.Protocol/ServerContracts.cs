...
public sealed record PublicServerDetails(
    ...
    PublicGameAddress? PublicAddress);

public sealed record PublicServerRules(
    [property: StringLength(128)] string? Difficulty,
    double? ExperienceRate,
    double? PalCaptureRate,
    double? PalSpawnRate,
    double? WorkSpeedRate,
    double? EggHatchingHours,
    double? ItemWeightRate,
    [property: StringLength(128)] string? DeathPenalty,
    double? PlayerDamageDealtRate,
    double? PlayerDamageTakenRate,
    double? PalDamageDealtRate,
    double? PalDamageTakenRate,
    double? PlayerHungerRate,
    double? PlayerStaminaRate,
    double? PalHungerRate,
    double? PalStaminaRate,
    double? CollectionDropRate,
    double? ResourceHealthRate,
    double? ResourceRespawnRate,
    double? EnemyDropRate,
    double? BuildingDamageRate,
    double? BuildingDeteriorationRate,
    int? MaxBasesPerGuild,
    int? MaxPlayersPerGuild,
    int? MaxBuildings,
    bool? HardcoreEnabled,
    bool? FastTravelEnabled,
    bool? InvasionsEnabled,
    bool? ClientModsAllowed,
    bool? BackupsEnabled,
    bool? VoiceChatEnabled,
    double? AutosaveSeconds,
    double? SupplyDropSeconds);
